...
import { Row, Col, Select, Avatar, Slider, Divider, Tooltip } from 'antd';
        ...
        <Row justify="space-between">
            ...
            <Col>
                <button style={{ fontSize: 20 }}>
                    <Tooltip trigger="click" title={name}>
        ...
        return (
            <div className="container">
                <Row justify="space-between" className="chartContainer">
                    <Col xs={24} md={12} style={{ marginTop: '30px' }}>
                    ...
                    >
                        <div className="activeUser" style={{ margin: '0 auto' }}>
                            <Row justify="space-between" style={{ marginBottom: '30px' }}>
                                ...
                                <Select
                                    defaultValue="8"
                                    dropdownStyle={{ backgroundColor: '#070333' }}
                                >
                                    {month.map((e) => (
